        ...
        <div class="card text-center w-100 h-100 all">
            <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs">
                    <li class="nav-item">
                        <a href="#" class="nav-link active" id="firstLink">Onay Bekleyen Şirketler </a>
                    </li>
            </div>
            <div class="card-body p-3">
                <div class="justify-content-between">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <?php
                            $ch = curl_init('https://socoolbus.herokuapp.com/adminPanel/getUnapprovedCompanies');
                            ...
                            if ($json != null && count($json) > 0) {
                                ...
                                foreach ($json as $item) {
                                    $city = $item['city'] ?? '';
                                    echo "<tr>
                                    <td>" . $item['companyName'] . "</th>
                                    
                                    <td>" . $item['whoAddedCompanyPhone'] . "</td>
                                    ...
                                    <form method='POST' action='approveCompany_operation.php' class='form-inline'>
                                ...
                                echo "<tr>
                                <td colspan = 10>Onay bekleyen şirket yok</td>
                                </tr>";
                            }
                            ?>
                        </tbody>
