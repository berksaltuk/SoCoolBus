...
<head>
    ...
    <title> Onay Bekleyen Şirket Adminleri<?php
                                            session_start();; ?></title>
</head>
        ...
        <div class="card text-center w-100 h-100 all">
            <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs">
                    <li class="nav-item">
                        <a href="#" class="nav-link active" id="firstLink">Onay Bekleyen Şirket Adminleri </a>
                    </li>
            </div>
            <div class="card-body p-3">
                <div class="justify-content-between">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <?php
                            $ch = curl_init('https://socoolbus.herokuapp.com/adminPanel/getUnapprovedCompanyAdmins');
                            ...
                            if (count($json) > 0) {
                                ...
                                foreach ($json as $item) {
                                    ...
                                    <td>" . $item['companyToken'] . "</td>

                                  

                                    <form method='POST' action='approveCompanyAdmin_operation.php' class='form-inline'>
                                    <input type='hidden' name='approve_sch' value='" . $item['phone'] . "'>
                                    <td><button type='submit' value = 'approve' name = 'approve'><span class='btn btn-success'>Onayla</span> </td> 
                                    <input type='hidden' name='reject_sch' value='" . $item['phone'] . "'>
                                ...
                                echo "<tr>
                                <td colspan = 10>Onay bekleyen şirket admini yok</td>
                                </tr>";
                            }
                            ?>
                        </tbody>
