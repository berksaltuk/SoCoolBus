...
<head>
    ...
    <title> Onay Bekleyen Dokümanlar<?php
                                    session_start();; ?></title>
</head>
        ...
        <div class="card text-center w-100 h-100 all">
            <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs">
                    <li class="nav-item">
                        <a href="#" class="nav-link active" id="firstLink">Onay Bekleyen Dokümanlar </a>
                    </li>
            </div>
            <div class="card-body p-3">
                <div class="justify-content-between">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <?php
                            $ch = curl_init('https://socoolbus.herokuapp.com/adminPanel/getUnapprovedDocuments');
                            ...
                            if (count($json) > 0) {
                                ...
                                foreach ($json as $item) {
                                    echo "<tr>
                                    <td>" . $item['documentName'] . "</th>
                                    
                                    <td>" . $item['driverPhone'] . "</td>
                                    
                                    <td>" . $item['documentType'] . "</td>
                                    <td><a href=" . $item['fileURL'] . ">Link</a></td>

                                  

                                    <form method='POST' action='approveDocument_operation.php' class='form-inline'>
                                ...
                                echo "<tr>
                                <td colspan = 10>Onay bekleyen doküman yok</td>
                                </tr>";
                            }
                            ?>
                        </tbody>
